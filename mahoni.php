...
$query = "SELECT * FROM gambar WHERE kategori='mahoni'";
                ...
                <ul>
                    ...
                    <li class="dropdown"><a href="#" class="active"><span>Galeri</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
                        <ul>
                            ...
                            <li><a href="mahoni.php" class="active">Bukit Mahoni</a></li>
                    ...
                    <?php foreach ($gambar as $dokumentasi) : ?>
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="gallery-item h-100">
                                <img src="assets/images/bukit mahoni/<?php echo $dokumentasi['images']; ?>" class="img-fluid" alt="">
                                <div class="gallery-links d-flex align-items-center justify-content-center">
                                    <a href="assets/images/bukit mahoni/<?php echo $dokumentasi['images']; ?>" title="Galeri Bukit Mahoni" class="glightbox preview-link"><i class="bi bi-arrows-angle-expand"></i></a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
