            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="dropdown"><a href="#" class="active"><span>Galeri</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
                        <ul>
                            <li><a href="galeri.php" class="active">Semua</a></li>
                    ...
                    <?php foreach ($gambar as $dokumentasi) : ?>
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="gallery-item h-100">
                                <img src="assets/images/all/<?php echo $dokumentasi['images']; ?>" class="img-fluid" alt="">
                                <div class="gallery-links d-flex align-items-center justify-content-center">
                                    <a href="assets/images/all/<?php echo $dokumentasi['images']; ?>" title="Galeri Wisata Bukit Mahoni" class="glightbox preview-link"><i class="bi bi-arrows-angle-expand"></i></a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
