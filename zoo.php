...
$query = "SELECT * FROM gambar WHERE kategori='zoo'";
                ...
                <ul>
                    ...
                    <li class="dropdown"><a href="#" class="active"><span>Galeri</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
                        <ul>
                            ...
                            <li><a href="zoo.php" class="active">Mini Zoo</a></li>
                    ...
                    <?php foreach ($gambar as $dokumentasi) : ?>
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="gallery-item h-100">
                                <img src="assets/images/zoo/<?php echo $dokumentasi['images']; ?>" class="img-fluid" alt="">
                                <div class="gallery-links d-flex align-items-center justify-content-center">
                                    <a href="assets/images/zoo/<?php echo $dokumentasi['images']; ?>" title="Galeri Mini Zoo" class="glightbox preview-link"><i class="bi bi-arrows-angle-expand"></i></a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
