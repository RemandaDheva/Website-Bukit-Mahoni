...
<body>
    ...
    <section class="beranda">
        <div class="text">
            <h1>Jelajahi Keajaiban Bukit Mahoni</h1>
            <h4>Destinasi Wisata Alam yang Menawan dan Menenangkan</h4>
            <div class="button">
                <a href="about.php" class="btn-get-started">Jelajahi Lebih Lanjut ></a>
            </div>
        </div>
