...
// Query untuk memuat data gambar berdasarkan kategori yang dipilih
$query = "SELECT * FROM gambar WHERE kategori='sports'";
$result = mysqli_query($koneksi, $query);

if ($result) {
    $gambar = mysqli_fetch_all($result, MYSQLI_ASSOC);
} else {
...
<body>
        ...
        <div class="container-fluid d-flex align-items-center justify-content-between">
            ...
            <nav id="navbar" class="navbar">
                <ul>
                    ...
                    <li class="dropdown"><a href="#" class="active"><span>Galeri</span> <i class="bi bi-chevron-down dropdown-indicator"></i></a>
                        <ul>
                            <li><a href="galeri.php">Semua</a></li>
                            <li><a href="mahoni.php">Bukit Mahoni</a></li>
                            <li><a href="zoo.php">Mini Zoo</a></li>
                            <li><a href="sports.php" class="active">Area Bermain</a></li>
                        </ul>
                    </li>
    ...
    <section id="gallery" class="gallery">
        <div class="headline">
            <h1>Galeri Wisata Bukit Mahoni</h1>
        </div>
        <div class="container-fluid">
            <?php if (!empty($gambar)) : ?>
                <div class="row gy-4 justify-content-center">
                    <?php foreach ($gambar as $dokumentasi) : ?>
                        <div class="col-xl-3 col-lg-4 col-md-6">
                            <div class="gallery-item h-100">
                                <img src="assets/images/area bermain/<?php echo $dokumentasi['images']; ?>" class="img-fluid" alt="">
                                <div class="gallery-links d-flex align-items-center justify-content-center">
                                    <a href="assets/images/area bermain/<?php echo $dokumentasi['images']; ?>" title="Galeri Area Bermain" class="glightbox preview-link"><i class="bi bi-arrows-angle-expand"></i></a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
            ...
            <?php else : ?>
                <p class="text-center">Tidak ada gambar galeri yang ditemukan.</p>
            <?php endif; ?>
        </div>
    </section>
    <!-- Section End -->
